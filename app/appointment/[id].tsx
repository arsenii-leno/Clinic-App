  ...
  const handleStatusChange = useCallback(
    async (newStatus: AppointmentStatus) => {
      ...
      try {
        ...
        Alert.alert('Unable to update appointment', 'Please try again.');
      }
    },
      ...
      { text: 'Cancel', style: 'cancel' },
      {
        ...
        onPress: async () => {
          try {
            ...
            Alert.alert('Unable to delete appointment', 'Please try again.');
          }
        },
      },
    ]);
  ...
  return (
    <View style={[styles.flex, { backgroundColor: colors.background }]}>
      ...
      >
        ...
        >
          <Text style={[styles.statusSectionTitle, { color: colors.foreground }]}>
            Change Status
          </Text>

...
export function StatusBadge({ status, size = 'md' }: Props) {
  ...
  const bgColor =
    status === 'scheduled' ? colors.statusScheduledBg :
    status === 'completed' ? colors.statusCompletedBg :
    status === 'cancelled' ? colors.statusCancelledBg :
    colors.statusRescheduledBg;

  const textColor =
    status === 'scheduled' ? colors.statusScheduled :

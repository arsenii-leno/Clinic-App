      ...
      >
        ...
        <View style={[styles.profileCard, { backgroundColor: colors.card, borderColor: colors.border }]}>
          ...
          <View style={styles.infoGrid}>
            <InfoRow icon="person-outline" label="Child" value={patient.childName || '—'} colors={colors} />
            <InfoRow icon="call-outline" label="Phone" value={patient.phone || '—'} colors={colors} />
            {patient.notes ? (
              <InfoRow icon="document-text-outline" label="Notes" value={patient.notes} colors={colors} />
            ) : null}
          </View>
          ...
          <View style={styles.sectionHeader}>
            ...
            {appointments.length > 0 && (
              <View style={[styles.countPill, { backgroundColor: colors.secondary }]}>
                <Text style={[styles.countText, { color: colors.primary }]}>{appointments.length}</Text>
              </View>
            )}
          </View>
